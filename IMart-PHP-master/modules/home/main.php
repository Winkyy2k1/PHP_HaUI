                        ...
                        <?php if (count($list_phone) > 0) {
                            for ($i = 0; $i < 8; $i++) {?>
                                ...
                                <div class="action clearfix">
                                    ...
                                    <a href="?mod=cart&act=checkout&pro_id=<?=$list_phone[$i]['pro_id']?>" title="Mua ngay" class="buy-now fl-right">Mua ngay</a>
                                </div>
                            </li>
                            <?php }?>
                        <?php } ?>
                            ...
                            for ($i = 0; $i < 8; $i++) {?>
                                <li>
                                    ...
                                    <div class="action clearfix">
                                        ...
                                        <a href="?mod=cart&act=checkout&pro_id=<?= $list_laptop[$i]['pro_id']?>" title="Mua ngay" class="buy-now fl-right">Mua ngay</a>
                                    </div>
                                    </li>
                            <?php }?>
                        <?php } ?>
                            ...
                            for ($i = 0; $i < 4; $i++) {?>
                                <li>
                                    ...
                                    <div class="action clearfix">
                                        ...
                                        <a href="?mod=cart&act=checkout&pro_id=<?= $list_tablet[$i]['pro_id']?>" title="Mua ngay" class="buy-now fl-right">Mua ngay</a>
                                    </div>
                                    </li>
                            <?php }?>
                        <?php } ?>
                            ...
                            for ($i = 0; $i < 8; $i++) {?>
                                <li>
                                    ...
                                    <div class="action clearfix">
                                        ...
                                        <a href="?mod=cart&act=checkout&pro_id=<?= $list_earphone[$i]['pro_id']?>" title="Mua ngay" class="buy-now fl-right">Mua ngay</a>
                                    </div>
                                    </li>
                            <?php }?>
                        <?php } ?>
