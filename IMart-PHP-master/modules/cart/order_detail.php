...
<div id="main-content-wp" class="cart-page">
    ...
    <div id="wrapper" class="wp-inner clearfix">
        <div class="section" id="info-cart-wp">
            <h2 style="font-size: 20px;text-transform: uppercase;margin: 20px 0 15px 0">Chi tiết thông tin đơn hàng</h2>
                                    ...
                                    <td class="thead-text" style="text-align: left; padding-left: 20px; width: 57%;">
                                        <div class="content" style="display:flex; align-items:center; justify-content: space-between;">
                                            <div class="left" style="width: 15%;">
                                                <div class="thumb">
                                                    <img src="<?= $r['pro_image'] ?>" alt="" width="100px" height="100px" style="text-align:center; object-fit: contain; width: 80%;">
                                                </div>
