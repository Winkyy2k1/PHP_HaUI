...
if(isset($_POST['btnthem']))
{
	$tendm=$_POST['tendm'];
	$dequi=$_POST['dequi'];
	$insertdm = mysqli_query(mysqli_connect("localhost","root","","dienthoai"),"INSERT INTO danhmuc VALUES('', '$tendm', '$dequi') ");
	if($insertdm) {
                    ...
                    <?php
						...
						while($show1 = mysqli_fetch_array($show))
						{
							...
							echo "<option value='".$madm."'>".$tendm."</option>";	
								$show2 = mysqli_query(mysqli_connect("localhost","root","","dienthoai"),"SELECT * FROM danhmuc WHERE dequi='".$madm."'");
