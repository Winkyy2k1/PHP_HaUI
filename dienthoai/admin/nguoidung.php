...
<table>
	...
	/*------------Phan trang------------- */
		...
		$sql = mysqli_query(mysqli_connect("localhost","root","","dienthoai"),"SELECT * FROM nguoidung LIMIT $from, $max_results"); 
...
?>
	...
	<?php
			...
			//$total_results = mysql_result(mysqli_query(mysqli_connect("localhost","root","","dienthoai"),"SELECT COUNT(*) as Num FROM nguoidung"),0);  
