...
<table>
	...
	/*------------Phan trang------------- */
		...
		$sql = mysqli_query(mysqli_connect("localhost","root","","dienthoai"),"SELECT * FROM sanpham inner join danhmuc on sanpham.madm=danhmuc.madm ORDER by idsp DESC  LIMIT $from, $max_results"); 
...
?>
	...
	<?php
			...
			$total_results = mysql_result(mysqli_query(mysqli_connect("localhost","root","","dienthoai"),"SELECT COUNT(*) as Num FROM sanpham"),0);  
