...
$query=mysqli_query(mysqli_connect("localhost","root","","dienthoai"),"SELECT * FROM danhmuc WHERE madm= '{$_GET['madm']}' ");  // OK nhé
// Cho vòng lặp vào
...
<form action="?admin=suadm&madm=<?php echo $row['madm']; ?>" method="post" name="frm" onsubmit="return kiemtra()"> <!-- $row ở đâu ra thế? -->
	<table>
		...
		<tr>
            ...
            $rows1=mysqli_query(mysqli_connect("localhost","root","","dienthoai"),$sql1);
