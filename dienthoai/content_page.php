    ...
    {    $action=$_GET['action'];}
		...
		if(isset($_GET['content']))
			...
			elseif(isset($_GET['madm'])) {
					...
					$query=mysqli_query(mysqli_connect("localhost","root","","dienthoai"),$sql);
					...
					?>
						...
						<div class="sanpham">	
							...
							$query1=mysqli_query(mysqli_connect("localhost","root","","dienthoai"),$sql1);
						...
						$total_results = mysql_result(mysqli_query(mysqli_connect("localhost","root","","dienthoai"),"SELECT COUNT(*) as Num FROM sanpham where madm='{$_GET['madm']}'"),0);  
				...
				<div class="sanpham">			
					...
					<div class="sanphamcon">
					    <?php 
							...
							$result1= mysqli_query(mysqli_connect("localhost","root","","dienthoai"),$sql1);
						?>
						<?php 
