<div id="tintuc">
	<h3>Tin Tức</h3>
	<?php
		//$select = mysqli_query(mysqli_connect("localhost","root","","dienthoai"),"select * from tintuc order by matt DESC");
...
<div id="phantrang_sp">
	...
	<?php
			...
			$total_results = mysql_result(mysqli_query(mysqli_connect("localhost","root","","dienthoai"),"SELECT COUNT(*) as Num FROM tintuc"),0);  
